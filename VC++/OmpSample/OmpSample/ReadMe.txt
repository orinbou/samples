================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: OmpSample プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した OmpSample には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには OmpSample アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
OmpSample.h
   ...
   COmpSampleApp アプリケーション クラスを宣言します。

OmpSample.cpp
   これは、アプリケーション クラス COmpSampleApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\OmpSample.ico
   ...
   アイコンはメイン リソース ファイル OmpSample.rc に含まれていま
   す。
...
OmpSampleDlg.h, OmpSampleDlg.cpp - ダイアログ
   これらのファイルは COmpSampleDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な OmpSample.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   OmpSample.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
