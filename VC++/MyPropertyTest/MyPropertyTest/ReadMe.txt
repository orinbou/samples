================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MyPropertyTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MyPropertyTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MyPropertyTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MyPropertyTest.vcxproj
...
MyPropertyTest.vcxproj.filters
...
MyPropertyTest.h
   ...
   CMyPropertyTestApp アプリケーション クラスを宣言します。

MyPropertyTest.cpp
   これは、アプリケーション クラス CMyPropertyTestApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MyPropertyTest.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MyPropertyTest.rc に含まれていま
   す。

res\MyPropertyTest.rc2
...
MyPropertyTestDlg.h, MyPropertyTestDlg.cpp - ダイアログ
   これらのファイルは CMyPropertyTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MyPropertyTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MyPropertyTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
