================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ClassInheritABTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ClassInheritABTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ClassInheritABTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

ClassInheritABTest.vcxproj
...
ClassInheritABTest.vcxproj.filters
...
ClassInheritABTest.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CClassInheritABTestApp アプリケーション クラスを宣言します。

ClassInheritABTest.cpp
   これは、アプリケーション クラス CClassInheritABTestApp を含むメイン アプリケー
   ション ソース ファイルです。

ClassInheritABTest.rc
...
res\ClassInheritABTest.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル ClassInheritABTest.rc に含まれていま
   す。

res\ClassInheritABTest.rc2
...
ClassInheritABTestDlg.h, ClassInheritABTestDlg.cpp - ダイアログ
   これらのファイルは CClassInheritABTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な ClassInheritABTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   ClassInheritABTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
